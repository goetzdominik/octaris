...
#define I_DIAG_PIN                         PF3   // M4-STOP
#define J_DIAG_PIN                         PF1   // M5-STOP
...
//
  ...
  #endif
#else
  #define I_STOP_PIN                  Z_DIAG_PIN  // Z-STOP
#endif
  ...
  #endif
#else
  #define J_STOP_PIN                  Z_DIAG_PIN  // Z-STOP
#endif
  ...
  #endif
#else
  #define K_STOP_PIN                  Z_DIAG_PIN  // Z-STOP
#endif


#ifdef U_STALL_SENSITIVITY
  #define U_STOP_PIN                  Z_DIAG_PIN
  #if U_HOME_TO_MIN
    #define U_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #else
    #define U_MIN_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#elif ENABLED(NEEDS_U_MINMAX)
  #ifndef U_MIN_PIN
    #define U_MIN_PIN                 Z_DIAG_PIN  // Z-STOP
  #endif
  #ifndef U_MAX_PIN
    #define U_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#else
  #define U_STOP_PIN                  Z_DIAG_PIN  // Z-STOP
#endif

#ifdef V_STALL_SENSITIVITY
  #define V_STOP_PIN                  Z_DIAG_PIN
  #if V_HOME_TO_MIN
  ...
  #endif
#else
  #define V_STOP_PIN                  Z_DIAG_PIN  // Z-STOP
#endif

#ifdef W_STALL_SENSITIVITY
  #define W_STOP_PIN                  Z_DIAG_PIN
  #if W_HOME_TO_MIN
    #define W_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #else
    #define W_MIN_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#elif ENABLED(NEEDS_W_MINMAX)
  #ifndef W_MIN_PIN
    #define W_MIN_PIN                 Z_DIAG_PIN  // Z-STOP
  #endif
  #ifndef W_MAX_PIN
    #define W_MAX_PIN                E2_DIAG_PIN  // PWRDET
  #endif
#else
  #define W_STOP_PIN                  Z_DIAG_PIN  // Z-STOP
#endif
...
#define I_STEP_PIN                         PB8   // MOTOR 4 A
#define I_DIR_PIN                          PB9
#define I_ENABLE_PIN                       PB7
#ifndef I_CS_PIN
  #define I_CS_PIN                         PG11
#endif

#define J_STEP_PIN                         PB5   // MOTOR 5 B
#define J_DIR_PIN                          PB4
#define J_ENABLE_PIN                       PB6
#ifndef J_CS_PIN
  #define J_CS_PIN                         PG10
#endif

#define K_STEP_PIN                         PG15  // MOTOR 6 C
#define K_DIR_PIN                          PB3
#define K_ENABLE_PIN                       PD5
#ifndef K_CS_PIN
  #define K_CS_PIN                         PG9
#endif

#define U_STEP_PIN                         PD3   // MOTOR 7
#define U_DIR_PIN                          PD2
#define U_ENABLE_PIN                       PD4
#ifndef U_CS_PIN
  #define U_CS_PIN                         PD7
#endif

#define V_STEP_PIN                         PA10  // MOTOR 8
#define V_DIR_PIN                          PA9
#define V_ENABLE_PIN                       PA15
#ifndef V_CS_PIN
  #define V_CS_PIN                         PD6
#endif

#define W_STEP_PIN                         PA8   // MOTOR 9
#define W_DIR_PIN                          PC7
#define W_ENABLE_PIN                       PC9
#ifndef W_CS_PIN
  #define W_CS_PIN                         PG8
#endif
